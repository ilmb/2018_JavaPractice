...
public class EdgeEditWindow extends JDialog {
	...
	public void save() {
		if (edge == null) {
			System.out.println("Невозможно сохранить несуществующее ребро");
			return;
		}
