...
public class VertexEditWindow extends JDialog {
	...
	public VertexEditWindow(Frame parent, String title) {
		...
		getContentPane().add(new JLabel("Вершина"));
		nameField = new JTextField();
		getContentPane().add(nameField);
	
		getContentPane().add(new JLabel("Координата X"));
		xField = new JSpinner();
		getContentPane().add(xField);
	
		getContentPane().add(new JLabel("Координата Y"));
		yField = new JSpinner();
	...
	public void save() {
		if (vertex == null) {
			System.out.println("Невозможно сохранить несуществующую вершину");
			return;
		}
